...
enum LocalizedStrings {
    ...
    private static let chineseText: [String: String] = [
        ...
        "previewHint": "实时查看当前桌面图像。",
        "currentFile": "当前文件",
        "activitySection": "最近活动",
        "activityDescription": "查看最近一次更换记录和当前错误状态。",
        "librarySection": "缓存管理",
        "libraryDescription": "管理本地缓存上限，或在需要时手动清除缓存图片。",
    ...
    private static let englishText: [String: String] = [
        ...
        "previewHint": "See the current desktop image at a glance.",
        "currentFile": "Current file",
        "activitySection": "Recent Activity",
        "activityDescription": "Track the latest wallpaper update and the current error state.",
        "librarySection": "Cache Management",
        "libraryDescription": "Manage your cache budget, open the local directory, or clear stored images.",
